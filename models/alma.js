...
function main() {
...

    {
        ...
        gltfLoader.load('lartA.gltf', (gltf) => {
            const a = gltf.scene;

            {
                const gltfLoader = new GLTFLoader();
                gltfLoader.load('lartB.gltf', (gltf) => {
                    const b = gltf.scene;
                    a.add(b);
                });
            }
            ...
            {
                const gltfLoader = new GLTFLoader();
                gltfLoader.load('lartC.gltf', (gltf) => {
                    const c = gltf.scene;
                    a.add(c);
                });
            }
            ...
            {
                const gltfLoader = new GLTFLoader();
                gltfLoader.load('lartD.gltf', (gltf) => {
                    const d = gltf.scene;
                    a.add(d)
                });
            }
            ...
            {
                const gltfLoader = new GLTFLoader();
                gltfLoader.load('lart_text.gltf', (gltf) => {
                    const d = gltf.scene;
                    a.add(d)
                });
            }
